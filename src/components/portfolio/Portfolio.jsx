      ...
      <div className="containerportfolioContainer">
        <article className="portfolioItem">
          ...
          <div className="portfolioitemCTA">
            <a
              href="https://github.com/munnos/Movietails"
              className="btn"
              target="_blank"
            >
              {' '}
        ...
        <article className="portfolioItem">
          ...
          <div className="portfolioitemCTA">
            <a
              href="https://github.com/munnos/Always-take-the-weather-with-you"
              className="btn"
              target="_blank"
            >
              Github
        ...
        <article className="portfolioItem">
          <div className="portfolioitemImage">
            <img
              src={ProjectImage3}
              alt="Text editor progressive web application"
            />
          </div>
          <h3>Text editor progressive web application</h3>
          <div className="portfolioitemCTA">
            <a
              href="https://github.com/munnos/edit-me-text-app"
              className="btn"
              target="_blank"
            >
              {' '}
        ...
        <article className="portfolioItem">
          ...
          <div className="portfolioitemCTA">
            <a
              href="https://github.com/munnos/9-to-5-Day-Organiser"
              className="btn"
              target="_blank"
            >
              {' '}
        ...
        <article className="portfolioItem">
          ...
          <div className="portfolioitemCTA">
            <a
              href="https://github.com/Beanalini/vibratingParticles"
              className="btn"
              target="_blank"
            >
              {' '}
        ...
        <article className="portfolioItem">
          ...
          <div className="portfolioitemCTA">
            <a
              href="https://github.com/munnos/password-generator"
              className="btn"
              target="_blank"
            >
              {' '}
